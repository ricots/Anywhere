...
public class DepartPhotoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_depart_photo);
	...
	private class ConfirmListener implements OnClickListener {
		public void onClick(View v) {
			...
			intent.setClass(DepartPhotoActivity.this, DestActivity.class);
			DepartPhotoActivity.this.startActivity(intent);
		}
	}
